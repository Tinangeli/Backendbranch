...
SECRET_KEY = 'django-insecure-s_f7x_4ihrt_z^n-*$52zrll@a%hmkt@y-x1m(lou7yqz$^%74'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'saintjude',       # Database name
        'USER': 'root',        # Database user
        'PASSWORD': 'password',        # Database password (keep empty if no password)
